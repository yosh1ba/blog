...
<div class="wrapper">
    <p class="breadcrumbs-item">プログラミングを勉強していく中での自分の知識整理を目的としたブログです。</p>
</div>
</section>
<section id="main">
<div class="wrapper">
                    ...
                    <div href="" class="post-content d-flex">
                        <div class="post-content-left">
                            ...
                            if (has_post_thumbnail() ) {
                                ...
                                echo '<img src="' . esc_url(get_template_directory_uri()) . '/img/thumbnail.jpg" alt="" class="post-thumbnail noimage">';
                            }
                            ?>
